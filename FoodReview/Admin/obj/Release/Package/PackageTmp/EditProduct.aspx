<%@ Page Title="" Language="C#" MasterPageFile="~/ComplianceMaster.Master" AutoEventWireup="true" CodeBehind="EditProduct.aspx.cs" Inherits="OnlineBidding.EditProduct" %>
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label></label>
                                <div class="form-group">
                                    <asp:Button runat="server" ID="btnEditProduct" Text="Edit Product" CssClass="btn btn-block btn-success" OnClick="btnEditProduct_Click" />
                                </div>
                            </div>
                        </div>
                        <!-- /.row -->
